class Solution:
    def minNumberOfFrogs(self, croakOfFrogs: str) -> int:
        ...
        cnt = defaultdict(int)                                  # <-- tracking counts of most-current letter in each uncompleted croak
        ...
        return cnt['k'] if sum(cnt.values())==cnt['k'] else -1  # <-- counts for all letters except for k should be zero; if
